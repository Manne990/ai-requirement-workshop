...
| -------------------------- | -------- | --------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| CI verification            | #35, #39 | A release ships with failing format, lint, types, tests, or build.                                              | `npm run ci` passes on the release candidate and GitHub Actions `verify` is green.                                                                         | Fail                             | Pending release-candidate run.                                                                                                                                                                                     |
...
| Traceability and approvals | #39      | Accepted requirements cannot be traced to source material or approval decisions.                                | Tests or review prove requirements, risks, decisions, artifacts, and approvals preserve links and audit history.                                           | Fail                             | Production export now prefers approved/baselined requirements, includes traceability gaps, and blocks review-scoped gaps via `src/domain/productionExport.test.ts`; production approval workflow is still pending. |
