...
| Durable persistence        | #23, #39 | Production data is browser-only or cannot recover after device loss.                                            | Server-backed workshop rows, attachment metadata, export/import, and backup/recovery procedure are verified.                                               | Fail                             | Supabase workshop snapshot adapter and fake-Supabase tests cover list/load/save plus ledger/audit preservation; real Supabase migration and cross-device recovery evidence are still pending.                      |
